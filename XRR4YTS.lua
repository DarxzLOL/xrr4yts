...
function XFusion:CreateWindow(Config)
    Config = Config or {}

    local Title = Config.Title or "XFusion"

    if CoreGui:FindFirstChild("XFusionUI") then
        CoreGui.XFusionUI:Destroy()
    end

    local ScreenGui = Instance.new("ScreenGui")
    ScreenGui.Name = "XFusionUI"
